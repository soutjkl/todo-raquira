...
import {
  ...
  setDescription,
  setTotal,
} from "../../features/cotizations/cotizationDataSlice";
...
export default function CotizationComponent() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const transport = descriptionState
      ? "Se incluye transporte"
      : "No se incluye transporte";
                  ...
                  {cotizationData.products.map((productAux, index) => {
                    return (
                      <li key={index} className="list-group-item">
                        <ListItem productItem={productAux} />
                      </li>
                    );
                  })}
                </ul>
                ...
                <div className="card" style={{ width: "80%" }}>
                  <div className="card-body text-end p-5">
                    <input
                      ...
                      type="checkbox"
                      value="Se incluye transporte"
                      id="flexCheckDefault"
                      onChange={(e) => setDescriptionState(!descriptionState)}
                    />
                    <label
                    ...
                    <h5 className="card-title mt-5" id="price">
                      <strong>Total:</strong> $
            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-4  text-center">
                <FontAwesomeIcon
                  ...
                  bounce
                  style={{ color: "#D2691E", width: "100px", height: "100px" }}
                />
              </div>
              ...
              <div className="row justify-content-center align-items-center ">
                <div className="col-4 mt-5  text-center">
                  <h5 id="subtitle">
                    Aun no has agregado ningún producto a tu cotización
                  </h5>
                </div>
              </div>
            </div>
        ...
        <ModalWindow state={modalState} setState={setModalState}>
          ...
          {cotizationCreated ? (
            ...
            <CotizationConfirmComponent
              state={modalState}
              setState={setModalState}
              setCotizationCreated={setCotizationCreated}
            />
          ) : (
            <ClientDataComponent
              state={modalState}
